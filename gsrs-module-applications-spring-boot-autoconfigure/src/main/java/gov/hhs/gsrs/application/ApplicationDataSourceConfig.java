...
@EnableJpaRepositories(
        entityManagerFactoryRef = ApplicationDataSourceConfig.NAME_ENTITY_MANAGER,
        transactionManagerRef = ApplicationDataSourceConfig.NAME_TRANSACTION_MANAGER,
        basePackages = {"gov.hhs.gsrs.application"}
)
@Slf4j
public class ApplicationDataSourceConfig extends GSRSDataSourceConfig {
    ...
    protected static final String[] BASE_PACKAGES = new String[] {"gov.hhs.gsrs.application"};
    protected static final String PERSIST_UNIT = "application";
